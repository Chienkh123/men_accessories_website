                                ...
                                <div class="wapper-lh">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="wrapper-phone_number">
                                            <input type="text" name="phone_number" placeholder="Điện thoại"
                                                class="form-control">
                                            <div class="errors" style="opacity: 0">...</div>
                                            <span class='icon-notify' style='right: 5px'></span>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="wrapper-content">
                                            <textarea id="content" placeholder="Nội dung liên hệ" class="form-control"
                                                rows="6"></textarea>
                                            <div class="errors" style="opacity: 0">...</div>
                                            <span class='icon-notify' style='right: 5px'></span>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <input type="button" name="submit" value="GỬI LIÊN HỆ"
                        ...
                        <div class="col-xs-12 col-sm-4 tt-right">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row phone">
                                    ...
                                    <div class="col-xs-11 right" style="padding-right: 0">
                                        <div class="name-title">Điện thọai:</div>
...
$(function() {
    $("input[name='name']").focusout(function() {
        ...
        if ($(this).val()) {
            ...
            if ($(this).val().length < 3 || $(this).val().length > 20) {
                ...
                $(this).next(".errors").css({
                    "opacity": 1
                });
                $(this).next(".errors").html("Họ tên phải nằm trong khoảng từ 3-20 kí tự !!");
                $(".wrapper-name .icon-notify").removeClass(
                    "glyphicon glyphicon-ok form-control-feedback");
                $(".wrapper-name .icon-notify").addClass(
    ...
    $("input[name='email']").focusout(function() {
        ...
        if ($(this).val()) {
            if (!filter.test($(this).val().trim())) {
                ...
                $(".wrapper-email .icon-notify").removeClass(
                    "glyphicon glyphicon-ok form-control-feedback");
                $(".wrapper-email .icon-notify").addClass(
                    "glyphicon glyphicon-remove form-control-feedback");
            } else {
                $(this).parent().removeClass("has-error has-feedback");
                $(this).parent().addClass("has-success has-feedback");
    ...
    $("input[name='phone_number']").focusout(function() {
        ...
        if ($(this).val()) {
            if (!filter.test($(this).val().trim())) {
                ...
                $(".wrapper-phone_number .icon-notify").removeClass(
                    "glyphicon glyphicon-ok form-control-feedback");
                $(".wrapper-phone_number .icon-notify").addClass(
                    "glyphicon glyphicon-remove form-control-feedback");
    ...
    $("input[name='address']").focusout(function() {
        if ($(this).val()) {
            ...
            $(this).next(".errors").html("...");
            $(".wrapper-address .icon-notify").removeClass(
                "glyphicon glyphicon-remove form-control-feedback");
            ...
            $(".wrapper-address .icon-notify").removeClass(
                "glyphicon glyphicon-ok form-control-feedback");
            $(".wrapper-address .icon-notify").addClass(
                "glyphicon glyphicon-remove form-control-feedback");
        }
    });
    ...
    $("#content").focusout(function() {
        if ($(this).val()) {
            ...
            $(this).next(".errors").html("...");
            $(".wrapper-content .icon-notify").removeClass(
                "glyphicon glyphicon-remove form-control-feedback");
            ...
            $(".wrapper-content .icon-notify").removeClass(
                "glyphicon glyphicon-ok form-control-feedback");
            $(".wrapper-content .icon-notify").addClass(
                "glyphicon glyphicon-remove form-control-feedback");
        }
    });
    ...
    $("input[name='submit']").click(function() {
        ...
        if ($("input[name='name']").val()) {
            ...
            if ($("input[name='name']").val().length < 3 || $("input[name='name']").val().length > 20) {
                ...
                $("input[name='name']").next(".errors").css({
                    "opacity": 1
                });
                $("input[name='name']").next(".errors").html(
                    "Họ tên phải nằm trong khoảng từ 3-20 kí tự !!");
                $(".wrapper-name .icon-notify").removeClass(
                    "glyphicon glyphicon-ok form-control-feedback");
                $(".wrapper-name .icon-notify").addClass(
                    "glyphicon glyphicon-remove form-control-feedback");
        ...
        if ($("input[name='email']").val()) {
            if (!filter.test($("input[name='email']").val().trim())) {
                ...
                $("input[name='email']").next(".errors").css({
                    "opacity": 1
                });
        ...
        if ($("input[name='phone_number']").val()) {
            if (!filter.test($("input[name='phone_number']").val().trim())) {
                ...
                $("input[name='phone_number']").next(".errors").css({
                    "opacity": 1
                });
                ...
                $(".wrapper-phone_number .icon-notify").addClass(
                    "glyphicon glyphicon-remove form-control-feedback");
            } else if ($("input[name='phone_number']").val().length < 10 || $(
                    "input[name='phone_number']").val().length > 11) {
                $("input[name='phone_number']").parent().removeClass("has-success has-feedback");
                $("input[name='phone_number']").parent().addClass("has-error has-feedback");
                $("input[name='phone_number']").next(".errors").css({
                    "opacity": 1
                ...
                $("input[name='phone_number']").next(".errors").html(
                    "Số điện thoại phải nằm trong khoảng từ 10-11 ký tự");
                $(".wrapper-phone_number .icon-notify").removeClass(
                    "glyphicon glyphicon-ok form-control-feedback");
                $(".wrapper-phone_number .icon-notify").addClass(
                    "glyphicon glyphicon-remove form-control-feedback");
        ...
        if ($("input[name='address']").val()) {
            ...
            $("input[name='address']").next(".errors").css({
                "opacity": 0
            });
