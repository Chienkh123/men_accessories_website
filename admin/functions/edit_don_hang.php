<?php
	...
	if(isset($_SESSION['order']) or !empty($_SESSION['order']) && isset($_GET['name']) && isset($_GET['email'])  && isset($_GET['sdt']) && isset($_GET['sonha']) &&  isset($_GET['code_order']) && isset($_GET['quan_huyen'])&& isset($_GET['id_customer']) ){
