                        ...
                        <select name="label_product" style='padding:5px 10px;border-radius:4px;display: block;'>
                            ...
                            ?>
                                <option style="text-transform: capitalize;"
                                    value="<?php echo $label['id_label']; ?>" <?php if ($label['id_label'] == $dong['id_label']) {
                                                                                    echo "selected='selected'";
                                                                                } ?>><?php echo $label['name_label']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
            ...
            <div class="form-group">
                ...
                <div class="wrap-img">
                    ...
                    ?>
                        ...
                        ?>
                    <div class=" more"><i class="glyphicon glyphicon-plus"></i>
                </div>
            </div>
...
<script type="text/javascript">
    window.onload = function() {
        ...
        $(".class option").each(function() {
            if ($(this).attr("value") == $(".wrap-category").attr("id")) {
