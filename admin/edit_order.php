...
<style>
    ...
    .add-order .info .title-left,
    .add-order .products .text-title {
        font-weight: bold;
        margin-top: 15px;
        margin-bottom: 15px;
    }
    ...
    .add-order .products .wrap_size .size_product,
    .add-order .products .soluong {
        padding: 6px 12px;
        font-size: 14px;
        line-height: 1.42857143;
        color: #555;
...
if (isset($_GET['code_order'])) {
    ...
    $query = "SELECT * FROM tb_order, tb_product,tb_district,tb_city, tb_customer WHERE tb_city.id_city = tb_district.id_city && tb_order.id_district = tb_district.id_district && tb_product.id_product = tb_order.id_product && tb_customer.id_customer = tb_order.id_customer && code_order='{$code_order}'";
...
<div class="add-order">
    <form name="frmadd-shiper" method="post" action="">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="info">
                    <h4 class="text-order">Đặt hàng #<span class="code_order"><?php echo $code_order; ?></span>
                        <span class="id_customer" style="display: none;"><?php echo $id_customer; ?></span>
                    </h4>
                    <div class="row">
...
<script type="text/javascript">
    window.onload = function() {
        ...
        var a = $('.tinhthanh').val();
        if ($('.tinhthanh').val()) {
            $.get("../xuli-tinhthanh/xuli-quanhuyen.php", {
                value: a,
                id_district: <?php echo $id_district ?>
            }, function(data) {
