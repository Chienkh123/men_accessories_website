    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        <form name="frmadd-video" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="code_city" value="<?php if (isset($_POST['code_city'])) {
                                                                echo $_POST['code_city'];
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_city" value="<?php if (isset($_POST['name_city'])) {
                                                                echo $_POST['name_city'];
