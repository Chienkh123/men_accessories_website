...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if (isset($_POST['submit'])) {
            $errors = array();
            // Kiểm tra các trường nhập liệu như trước
            ...
            if (empty($errors)) {
                ...
                if (mysqli_num_rows($result) == 1) {
                    ...
                    // Nếu type_user = 2, thêm vào bảng tb_customer
                    if ($type_user == 2 && $result_in) {
                        $user_id = mysqli_insert_id($dbc); // Lấy ID vừa được thêm vào tb_user
                        $query_customer = "INSERT INTO tb_customer(name_customer, phonenumber_customer, email_customer, address_customer, id_user) 
                                               VALUES('{$hoten}', '{$dienthoai}', '{$email}', '{$diachi}','{$user_id}')";
