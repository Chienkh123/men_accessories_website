...
<div class="collapse navbar-collapse navbar-ex1-collapse wrap-sidebar">
    <ul class="nav navbar-nav side-nav">
        <li style="color:#fff;">
          <a href="index.php" style="color:#fff;"><img src="../image/SHOP(1).png" width="100%"></a>
        </li>
...
<li class="li-first khach-hang">
    <a href="javascript:;" data-toggle="collapse" data-target="#dskhachhang"><i class="fa fa-users" aria-hidden="true"></i>
      Khách hàng<i class="fa fa-fw fa-angle-double-down"></i>
    </a>
    <ul id="dskhachhang" class="collapse">
        <li class="dskhachhang">
            <a href="list_customer.php"><i class="fa fa-users" aria-hidden="true"></i> Danh sách</a>
        </li>
