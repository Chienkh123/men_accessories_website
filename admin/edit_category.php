    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        <form name="frmadd-video" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="code_category" value="<?php if (isset($_POST['code_category'])) {
                                                                    echo $_POST['code_category'];
                                                                }
                                                                echo $dong['code_category']; ?>" class="form-control" placeholder='Mã loại sản phẩm' />
            </div>

            <div class="form-group">
                <label>Tên loại sản phẩm</label>
                <input type="text" name="name_category" value="<?php if (isset($_POST['name_category'])) {
                                                                    echo $_POST['name_category'];
                                                                }
                                                                echo $dong['name_category']; ?>" class="form-control" id="name_category" current_id="<?php echo $id; ?>" parent_id="<?php echo $dong['parent_id'] ?>" placeholder='Tên loại sản phẩm' />
            </div>
