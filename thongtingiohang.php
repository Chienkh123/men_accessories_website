...
<body style="margin-top: -20px">
	<?php
	session_start();
	if (!isset($_SESSION['customer_uid']) || empty($_SESSION['customer_uid'])) {
		...
		<div class="container">
			<div class="row">
						...
						<div class="lienhe">
							...
							<div class="form-group height">
								...
								<div class="col-xs-12 col-lg-8 wrapper-name">
									<input type="text" name="name" class="form-control" value="<?php echo $name_customer; ?>" disabled>
							...
							<div class="form-group height">
								...
								<div class="col-xs-12 col-lg-8 wrapper-email">
									<input type="text" name="email" class="form-control" value="<?php echo $customer['email_customer']; ?>" disabled>
									<div class="errors"></div>
									<span class='icon-notify' style='right: 20px'></span>
								</div>
							</div>
							<div class="form-group height">
								...
								<div class="col-xs-12 col-lg-8 wrapper-phone_number">
									<input type="text" name="phone_number" class="form-control" value="<?php echo $customer['phonenumber_customer']; ?>" disabled>
									<div class="errors"></div>
									<span class='icon-notify' style='right: 20px'></span>
								</div>
							</div>
				...
				<div class="col-xs-12 col-sm-6 right">
					<h3>Giỏ hàng của bạn<small class="load" style="float: right;opacity:0;transition: all 1s;">Cập nhật thành công</small>
					...
					<table class="table">
						...
						<tbody class="tt_product">
							...
							<?php
									$soluong = 0;
									foreach ($value['quantity'] as $value1) {
										$soluong++;
									}
									echo $soluong + 1;
							...
							" class="sl-product">
										...
										<td class="sl-product<?php echo $value['id_product']; ?>"><?php $soluong_product = 0;
																									foreach ($value['quantity'] as $sl_product) {
																										$soluong_product += $sl_product;
																									}
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('.tt_product .delete-product').click(function() {
				...
				$.get('xuli-seeproduct/delete-size.php', {
					id: id,
					size: size
				}, function(data) {
					if (data == 1) {
